...
public final class ModuleInfo implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        com.solidworks.notekeeper.ModuleInfo that = (com.solidworks.notekeeper.ModuleInfo) o;
    ...
    public static final Creator<ModuleInfo> CREATOR =
            new Creator<ModuleInfo>() {
                ...
                @Override
                public com.solidworks.notekeeper.ModuleInfo createFromParcel(Parcel source) {
                    return new com.solidworks.notekeeper.ModuleInfo(source);
                }

                @Override
                public com.solidworks.notekeeper.ModuleInfo[] newArray(int size) {
                    return new com.solidworks.notekeeper.ModuleInfo[size];
                }
            };
